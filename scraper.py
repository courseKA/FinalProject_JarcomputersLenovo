...
#     # Намирам всички числа с десетична точка
#         matches = re.findall(r'\d+\.\d+', price_text)
#         if matches:
#             return float(matches[0])  # вземаме само първото число
#         else:
#         # ако няма десетично число, търсим цели числа
...
#         for item in data:
#             cursor.execute("""
#                 INSERT INTO customers (model, price, screen_size)
#                 VALUES (%s, %s, %s)
